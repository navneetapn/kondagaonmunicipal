            ...
            <div className="footerLinks py-2">
                <Container>
                    <ul className="footerLinksList list-unstyled m-0">
                        ...
                        <li className="">
                            <a href={basePath + "/about"}>Introduction of Kondagaon</a>
                        </li>
                        <li className="">
                            <a href="/about/korbamap">Kondagaon Map</a>
                        </li>
                        <li className="">
                        ...
                        <Col className="col col-sm-12 col-md-12">
                            <div className="text-description text-light">
                                <div className="footer-content">
                                    <p>An official website of Kondagaon Municipal Corporation</p>
                                    <p>Content on this website is published and managed by Kondagaon Municipal Corporation</p>
                                    <p>Copyright © 2021. <a href="http://kondagaonmunicipal.in">kondagaonmunicipal.in</a> &nbsp;All Rights Reserved.</p>
                                </div>
                            </div>
                        </Col>
                    </Row>
