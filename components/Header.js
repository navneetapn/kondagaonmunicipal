...
export default function Header() {
    ...
    useEffect(() => {
        fetch("http://admin.kondagaonmunicipal.in/api/settings")
            .then(res => res.json())
            .then(
                (result) => {
                    setIsLoaded(true);
                        ...
                        <Navbar.Collapse id="basic-navbar-nav">
                            <Nav className="me-auto">
                                ...
                                <NavDropdown title="About Us">
                                    <NavDropdown.Item href={basePath + "/about"}>Introduction of Kondagaon</NavDropdown.Item>
                                    <NavDropdown.Item href={basePath + "/about/korbamap"}>Map of Kondagaon</NavDropdown.Item>
                                    <NavDropdown.Item href={basePath + "/about/social-geological-of-korba"}>Social and Geological of Kondagaon</NavDropdown.Item>
                                ...
                                <NavDropdown title="APPs">
                                    <NavDropdown.Item className="dropdown-item" href={basePath + "/info-needed"}>Kondagaon Nigam Palika For You</NavDropdown.Item> 
