...
export default function Homepage() {
	...
	useEffect(() => {
		fetch("http://admin.kondagaonmunicipal.in/api/notices")
			.then(res => res.json())
			.then(
				(result) => {
					setIsLoaded(true);
	...
	useEffect(() => {
		fetch("http://admin.kondagaonmunicipal.in/api/ministers")
			.then(res => res.json())
			.then(
				(result) => {
					setIsLoaded(true);
	...
	useEffect(() => {
		fetch("http://admin.kondagaonmunicipal.in/api/tenders")
			.then(res => res.json())
			.then(
				(result) => {
					setIsLoaded(true);
	...
	useEffect(() => {
		fetch("http://admin.kondagaonmunicipal.in/api/banners")
			.then(res => res.json())
			.then(
				(result) => {
					setIsLoaded(true);
	...
	useEffect(() => {
		fetch("http://admin.kondagaonmunicipal.in/api/video")
			.then(res => res.json())
			.then(
				(result) => {
					setIsLoaded(true);
	...
	useEffect(() => {
		fetch("http://admin.kondagaonmunicipal.in/api/latest-gallery")
			.then(res => res.json())
			.then(
				(result) => {
					setIsLoaded(true);
	...
	return (
		<>
		   <Helmet>
                <meta charSet="utf-8" />
                <title>Home | Kondagaon Municipal Corporation</title>
            </Helmet>
			<Carousel>
								...
								<Accordion.Item className="">
									...
									<Accordion.Body>
										<ul className=" list-unstyled m-0">
											...
											<li className=""><a href={basePath + "/info-needed"}>Geotagging Details Kondagaon</a></li>
								...
								<Accordion.Item className="">
									...
									<Accordion.Body>
										<ul className=" list-unstyled m-0">
											...
											<li className=""><a href={basePath + "/info-needed"}>Smart City Kondagaon Public Poll</a></li>
											<li className=""><a href={basePath + "/info-needed"}>Credit Rating Kondagaon</a></li>
										</ul>
									</Accordion.Body>
								</Accordion.Item>
							</Accordion>
								...
								<Accordion.Item className="">
									...
									<Accordion.Body>
										<ul className=" list-unstyled m-0">
											...
											<li className=""><a href={basePath + "/info-needed"}>SLIP / SLBM Kondagaon</a></li>
										</ul>
									</Accordion.Body>
								</Accordion.Item>
							</Accordion>
